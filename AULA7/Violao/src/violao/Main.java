...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ViolaoPrototype violaoFlet = violaoFolk.clonar();
        ...
        ViolaoPrototype violaoJumbo = violaoFlet.clonar();
        ...
        ViolaoPrototype violao7Cordas = violaoJumbo.clonar();
        ...
        ViolaoPrototype violao12Cordas = violao7Cordas.clonar();
        ...
        ViolaoPrototype violaoParlor = violao12Cordas.clonar();
        ...
        System.out.println("\n\n"+ violaoFolk.exibirInfo());
        System.out.println("\n\n"+ violaoFlet.exibirInfo());
        System.out.println("\n\n"+ violaoJumbo.exibirInfo());
        System.out.println("\n\n"+ violao7Cordas.exibirInfo());
        System.out.println("\n\n"+ violao12Cordas.exibirInfo());
        System.out.println("\n\n"+ violaoParlor.exibirInfo());
